<template>
  <div class="layout-sider-container" :class="{ appMove: navStore.appMove }">
    ...
    <n-layout-sider collapse-mode="width" :collapsed-width="navStore.collapsedWidth" width="180"
      :native-scrollbar="false" :collapsed="navStore.collapsed" class="layout-sider">
...
// 获取菜单
const getMenusData = () => {
  menuOptions.value = generateMenu(menusConfig);
  // initMenus().then((res) => {
